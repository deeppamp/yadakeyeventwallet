...
import { getDefaultBlockchain } from "../shared/constants";

const AppContext = createContext();

export const AppProvider = ({ children }) => {
  const [selectedBlockchain, setSelectedBlockchain] = useState(getDefaultBlockchain()); // Default to first enabled blockchain
