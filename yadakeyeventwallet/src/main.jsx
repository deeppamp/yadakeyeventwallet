...
import { getDefaultBlockchain } from "./shared/constants.js";
...
// Root component
function Root() {
  const [primaryColor, setPrimaryColor] = useState(getDefaultBlockchain().color); // Initial primary color from first enabled blockchain
